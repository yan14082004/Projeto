...
<body>
		...
		<form id="login" name="login" class="login" method="post" action="valida_login.php">
				...
				<div class="agrupamento">
					...
					<div class="caixa" ><img src="logo.png" alt=""></div>
					...
					<div class="form">
						...
						<div style="padding-left: 5rem;">Não tem conta? <a href="cadastro/cadastro.php" style="color: white">Criar uma conta</a></div>
